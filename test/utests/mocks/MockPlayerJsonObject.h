...
class MockPlayerJsonObject : public PlayerJsonObject
{
public:
    ...
    MOCK_METHOD(bool, add, (const std::string& name, PlayerJsonObject& value));
    MOCK_METHOD(bool, add, (const std::string& name, std::vector<PlayerJsonObject*>& values));
    ...
    MOCK_METHOD(bool, set, (PlayerJsonObject *parent, cJSON *object));

    MOCK_METHOD(bool, get, (const std::string& name, PlayerJsonObject &value));
