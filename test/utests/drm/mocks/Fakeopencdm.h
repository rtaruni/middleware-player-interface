...
#ifndef FAKE_OPEN_CDM_H
#define FAKE_OPEN_CDM_H
...
extern "C"
{
	...
	typedef void (*MockConstructSessionCallback)(const MockOpenCdmSessionInfo *session,
												 void *mockUserData);
	typedef void (*MockSessionUpdateCallback)(const MockOpenCdmSessionInfo *session,
