 ...
 */
char *Base64Utils::base64Encode(const unsigned char *src, size_t len)
{
 ...
 * @retval return value from base64Decode value
 */
unsigned char *Base64Utils::base64Decode(const char *src, size_t *outLen, size_t srcLen)
{
...
unsigned char *Base64Utils::base64Decode(const char *src, size_t *len)
{
	return Base64Utils::base64Decode(src, len, strlen(src));
}
