...
namespace Base64Utils
{
	 ...
	 */
	char *base64Encode(const unsigned char *src, size_t len);
	 ...
	 */
	unsigned char *base64Decode(const char *src, size_t *len);
	 ...
	 */
	unsigned char *base64Decode(const char *src, size_t *len, size_t srcLen);
}	//namespace Base64Utils
