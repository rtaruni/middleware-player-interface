...
if(PC_WPEFRAMEWORK_FOUND)
    message(STATUS "Naren PC_WPEFRAMEWORK_FOUND = true")
    if(WPEFRAMEWORK_FIND_VERSION AND PC_WPEFRAMEWORK_VERSION)
        message(STATUS "Naren WPEFRAMEWORK_FIND_VERSION AND PC_WPEFRAMEWORK_VERSION = true")
    ...
    message(STATUS "Naren PC_WPEFRAMEWORK_FOUND = false")
...
if (USE_THUNDER_R4)
    message(STATUS "Naren USE_THUNDER_R4 = true")
...
if (NOT DISABLE_SECURITY_TOKEN)
    ...
    if("${WPEFRAMEWORK_INCLUDE_DIRS}" STREQUAL "" OR "${WPEFRAMEWORK_LIBRARY}" STREQUAL "")
        message(STATUS "Naren Internal condition 1")
        set(WPEFRAMEWORK_FOUND_TEXT "Not found")
    else()
        message(STATUS "Naren Internal condition 2")
